...
class SidesSelection extends StatefulWidget {
  var userdata;

  var data;

  SidesSelection({Key key,@required this.data,@required this.userdata}):super(key:key);
  @override
  _SidesSelectionState createState() => _SidesSelectionState();
}

class _SidesSelectionState extends State<SidesSelection> {
...
//    loadCrust();
  ...
  Future getApi() async
  {
    http.Response response= await http.get(Uri.encodeFull("https://dominosclone.herokuapp.com/api/sidescustomize"),
        headers: {
                  ...
                  children: <Widget>[
                    RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          {
                            _showAlert('Please Select Sauce and Grilltype');
                          }
                        }),
                  ],
                ),
